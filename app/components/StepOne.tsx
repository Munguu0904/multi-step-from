    ...
    >
      <div className="flex flex-col items-start gap-4">
        ...
        <div>
          ...
          <p className="r text-[15px] underline ">
      ...
      <form onSubmit={handleSubmit(onNext)} className="flex flex-col gap-5">
        ...
        <button
          type="submit"
          className="w-full bg-[#18181B] text-white py-4 rounded-2xl hover:bg-black font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.98] mt-4 shadow-md"
        >
